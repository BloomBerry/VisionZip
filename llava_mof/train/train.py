...
class TrainingArguments(transformers.TrainingArguments):
    ...
    project: str = field(default="posterLlava-miridih-instruction", metadata={"help": "W&B project name"})
...
def train():
    ...
    if training_args.exp_name == "":
        if training_args.local_rank == 0:
            wandb.init(project=training_args.project)
    else:
        print("experiment: ", training_args.exp_name)        
        if training_args.local_rank == 0:
            # wandb.init(project=training_args.project, name=training_args.exp_name, id="p8o1r74u", resume="allow")
            wandb.init(project=training_args.project, name=training_args.exp_name)
